#!/usr/bin/env python3
"""Triangular YC4 strip unit-cell geometry."""
...
def build(Ly=4, J=1.0, **kwargs):
    ...
    for a in range(Ly):
        ...
        _append_edge_map(payload["inter_cell"], J, (a, (a + 1) % Ly))
    for a in range(Ly):
        _append_edge_map(payload["intra_cell"], J, (a, (a + 1) % Ly))
    return payload


def main() -> None:
    parser = argparse.ArgumentParser(description="Compute the triangular YC4 unit-cell geometry.")
